...
const RARITY_ITEMS = {
  ...
  rare: ['lost_crown', 'ancient_scroll', 'iron_buried_sword', 'cursed_ring', 'obsidian_shard', 'moon_stone', 'emerald_shard', 'runic_bone', 'ember_core', 'frost_shard', 'lost_depth_pickaxe'],
  epic: ['abyss_crystal', 'ancient_idol', 'black_diamond', 'royal_steel'],
  very_rare: ['ari_lost_diamond', 'abyss_steel', 'sun_crystal', 'ancient_core', 'titan_scale', 'void_thread', 'lost_abyss_pickaxe'],
